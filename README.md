...
<span style="color:blue">**ATTENTION**: We provide separate instructions for each of our methods. Our second method's implementation code and README can be found in  **target-distractor_segmentation** folder.</span>
